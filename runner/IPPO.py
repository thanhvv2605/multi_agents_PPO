...
if __name__ == "__main__":
    ...
    env = WRSN(scenario_path="physical_env/network/network_scenarios/_30targets_107sensors.yaml"
    ...
    controller.train(10000, save_folder="save_model/ippo_30_target_multi_processes")
